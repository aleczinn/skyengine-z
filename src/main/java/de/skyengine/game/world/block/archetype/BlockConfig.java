...
public final class BlockConfig {
    ...
    private final Map<Property<?>, Object> defaultValues;
    ...
    private BlockConfig(Builder b) {
        ...
        this.defaultValues = Map.copyOf(b.defaultValues);
    ...
    /**
     * Abweichende Default-Werte einzelner Properties. Ohne Eintrag ist der Default-State der
     * erste Wert jeder Property (Deklarationsreihenfolge) — bei {@code AXIS {X, Y, Z}} also die
     * liegende Säule, weshalb der Pillar-Archetyp hier {@code AXIS=Y} setzt.
     */
    public Map<Property<?>, Object> defaultValues() {
        return defaultValues;
    }

    public List<BlockBehavior> behaviors() {
        return behaviors;
    }
     ...
     */
    public boolean placeOnFullTop() {
        return placeOnFullTop;
    }
     ...
     */
    public de.skyengine.audio.BlockSoundGroup soundGroup() {
        return soundGroup;
    }
    ...
    public static final class Builder {
        ...
        /**
         * Weicht vom „erster Wert gewinnt"-Default ab (s. {@link BlockConfig#defaultValues()}).
         */
        public <T> Builder defaultValue(Property<T> p, T value) {
            this.defaultValues.put(p, value);
            return this;
        }

        public Builder behavior(BlockBehavior b) {
            this.behaviors.add(b);
            return this;
        }

        public Builder shapes(ShapeProvider s) {
            this.shapeProvider = s;
            return this;
        }

        public Builder model(ModelGenerator m) {
            this.modelGenerator = m;
            return this;
        }
        ...
        public Builder randomOffset(boolean v) {
            this.randomOffset = v;
            return this;
        }
        ...
        public Builder connectionGroup(String g) {
            this.connectionGroup = g;
            return this;
        }

        public Builder blockEntity(BlockEntityType<?> t) {
            this.blockEntityType = t;
            return this;
        }

        public Builder tickRandomly(boolean v) {
            this.tickRandomly = v;
            return this;
        }

        public Builder fluid(FluidInfo f) {
            this.fluidInfo = f;
            return this;
        }

        public Builder tint(int t) {
            this.tint = t;
            return this;
        }

        public Builder tintType(int t) {
            this.tintType = t;
            return this;
        }

        public Builder tintFaces(int mask) {
            this.tintFaceMask = mask;
            return this;
        }

        public Builder overlayTexture(String path) {
            this.overlayTexture = path;
            return this;
        }

        public Builder placeOn(List<String> ids) {
            this.placeOn = ids;
            return this;
        }

        public Builder placeOnFullTop(boolean v) {
            this.placeOnFullTop = v;
            return this;
        }
