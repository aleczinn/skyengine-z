...
public final class DebugOverlay {
    ...
    private static List<WorkerPanel> workerPanels(PerformanceProfiler.ProfilerSnapshot snapshot) {
        ...
        panels.add(new WorkerPanel("L0", List.of(
                ...
                row("Snapshot/chunk", snapshot.l0().get(PerformanceProfiler.WorkerSection.L0_SNAPSHOT_FREEZE)),
                row("  Lock wait", snapshot.l0().get(PerformanceProfiler.WorkerSection.L0_SNAPSHOT_LOCK_WAIT)),
                row("  Lock hold", snapshot.l0().get(PerformanceProfiler.WorkerSection.L0_SNAPSHOT_LOCK_HOLD)),
                row("Wire encode", snapshot.l0().get(PerformanceProfiler.WorkerSection.L0_WIRE_ENCODE)),
                row("Wire zstd", snapshot.l0().get(PerformanceProfiler.WorkerSection.L0_WIRE_COMPRESSION)),
                row("Client decode", snapshot.l0().get(PerformanceProfiler.WorkerSection.L0_REMOTE_DECODE)),
                row("Client install", snapshot.l0().get(PerformanceProfiler.WorkerSection.L0_CLIENT_INSTALL)),
                ...
                row("Delta COW", snapshot.l0().get(PerformanceProfiler.WorkerSection.L0_CLIENT_DELTA_COW)),
