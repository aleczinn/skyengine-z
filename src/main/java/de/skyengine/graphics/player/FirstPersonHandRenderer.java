...
public final class FirstPersonHandRenderer {
    ...
    /* Fix wie Vanilla und bewusst UNABHÄNGIG von Kamera-FOV und Ultrawide-Deckel: diese Projektion
       bestimmt die BILDSCHIRM-Größe der Hand, ein mitgezogener FOV bläst sie auf (auf 32:9 waren
       das Faktor 2,1 — die Hand füllte die halbe Bildecke). Mehr Bildbreite zeigt mehr Welt neben
       der Hand; die Hand selbst bleibt gleich groß. */
