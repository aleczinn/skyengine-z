...
public final class FirstPersonHandRenderer {
    ...
    private static final double HAND_DEPTH_BAND = 0.01;
    ...
    public void render(PlayerRenderer playerRenderer, HeldItemMeshes items, EntityPlayer player,
        ...
        /* Eigener schmaler Nahbereich: Hand bleibt vor der Welt und sortiert sich weiterhin
           selbst, ohne den Welt-Depthbuffer zu loeschen. Dessen Inhalt wird nachher fuer
           TAA und den Unterwasser-Fog rekonstruiert. */
        GL11.glDepthRange(reversedDepth ? 1.0 - HAND_DEPTH_BAND : 0.0,
                reversedDepth ? 1.0 : HAND_DEPTH_BAND);
        try {
