...
/**
 * Offene long→int-Map (lineares Sondieren, Pow2-Kapazität, Load-Faktor 0,75) — Gegenstück zu
 * {@link LongObjMap} für primitive Werte ({@code HashMap<Long, Integer>}-Ersatz; als Long-Set
 * nutzbar über {@code put(key, 1)} + {@link #containsKey}). NICHT threadsicher.
 *
 * <p>Belegung wird über ein eigenes {@code used}-Array markiert (int hat kein null);
 * Entfernen per Backward-Shift. Iteration cursor-basiert wie bei {@link LongObjMap}:
 * {@link #tableSize()} + {@link #usedAt}/{@link #keyAt}/{@link #valueAt}.</p>
 */
public final class LongIntMap {
    ...
    /** Fibonacci-Streuung: Chunk-/Regionen-Keys clustern in den unteren Bits. */
